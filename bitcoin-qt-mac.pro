...
isEmpty(BOOST_LIB_PATH) {
    BOOST_LIB_PATH = /usr/local/Cellar/boost/1.71.0/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    BOOST_INCLUDE_PATH = /usr/local/Cellar/boost/1.71.0/include
}
...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_CFLAGS += -mmacosx-version-min=10.12 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
    macx:QMAKE_OBJECTIVE_CFLAGS += -mmacosx-version-min=10.12 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk
}
...
ICON = src/qt/res/icons/infinitecoin.icns
